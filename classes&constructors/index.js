    ...
    constructor(first, last, username, email, sci_id, dutyStatus){
        ...
        this.dutyStatus = dutyStatus
            ...
            let setSystemId = function() {
                console.log(this.sci_id + "has limited access!")
            }
    }
}
...
//PART FOUR
let userEx = new User ("Bob", "Oppenheimer", "CastleBravo", "atom@breakers.com");
let divHead = new ScienceHeads ("Bob", "Oppenheimer", department, sector);
